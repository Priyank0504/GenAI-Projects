...
def summarize_text_gemini(text, duration):
    ...
    prompt = f"Summarize this research paper in {duration_prompt} spoken by a single narrator. It should be suitable for text-to-speech."
...
if uploaded_file is not None:
    ...
    if st.button("Generate Podcast"):
        ...
        output_audio_path, transcript = generate_podcast_from_pdf(temp_pdf_path, output_audio_file, duration_option)
